...
# Your DQN class and its components go here
import random
...
class DQN:
    ...
    def select_action(self, state):
        probs = F.softmax(self.model(Variable(state, volatile=True)) * 7, dim=1)
...
env = gym.make("CartPole-v1")  # Use a simpler environment to verify everything works first
